  ...
  render() {
    return (
			...
			<div className="container-movie">
				...
				<div style={{width:"90%",marginLeft:"98px",bottom:"15px", left:"16px", position:"absolute"}}><SuggestedMovies/></div>
				...
				<div style={{bottom:"720px", left:"450px",fontSize:"1em",fontWeight:"100px",color:"white",width:"64%",position:"absolute"}}>{this.state.select_movie.overview}</div>
			</div>
